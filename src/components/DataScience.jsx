      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '1.5rem 1rem 0 1rem', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ 
          ...
          <p style={{ 
            ...
            Master advanced algorithms and machine learning techniques to solve complex real-world problems
          </p>
        </div>
          ...
          <div style={{
            ...
            <div className="hero-overlay" style={{
              ...
              <p style={{ 
                ...
                Transform your career with our comprehensive Data Science program, designed to take you from beginner to expert. Learn the complete data workflow — from data collection and cleaning to visualization and machine learning. Master essential tools like Python, SQL, Power BI, and Tableau while building real-world projects that showcase your skills. Gain the confidence to analyze, interpret, and present data-driven insights effectively. Step into the future of tech as a skilled and industry-ready Data Scientist.
              </p>
        ...
        {/* Topics Section with Scrollable Text Table */}
        <div style={{ 
          padding: '0'
        }}>
